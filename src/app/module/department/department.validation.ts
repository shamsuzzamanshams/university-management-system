...
const createDepartmentZodSchema = z.object({
  body: z.object({
    name: z.string("Department name must be a string.").min(30, "Department name must be at least 3 characters long."),
...
const updateDepartmentZodSchema = z.object({
  body: z.object({
    name: z.string("Department name must be a string.").min(30, "Department name must be at least 3 characters long.")  .optional(), // Fields are optional on patch updates
